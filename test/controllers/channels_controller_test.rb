...
class ChannelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create channel" do
    assert_difference("Channel.count") do
      post channels_url, params: { channel: { discord_id: @channel.discord_id, name: @channel.name, type: @channel.type } }
    end
  ...
  test "should update channel" do
    patch channel_url(@channel), params: { channel: { discord_id: @channel.discord_id, name: @channel.name, type: @channel.type } }
